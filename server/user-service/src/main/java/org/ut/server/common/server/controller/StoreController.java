...
import org.ut.server.common.server.service.StoreService;
...
public class StoreController {
    ...
    // add new store
    @PostMapping("/create")
    public GenericResponseDTO<StoreDto> addNewStore(@RequestBody StoreDto newStore, @RequestHeader("userId") UUID userId) {
        try {
